# Ahora crear el script completo con todas las dependencias instaladas
...
with open('analizador_subdominios.py', 'w', encoding='utf-8') as f:
    f.write(script_content)

print("✅ Script 'analizador_subdominios.py' creado exitosamente")
print("\n📋 CARACTERÍSTICAS DEL SCRIPT:")
print("• Solicita dominios al usuario de forma interactiva")
print("• Enumera subdominios usando una lista de subdominios comunes")
print("• Verifica existencia via DNS y conectividad HTTP/HTTPS")
print("• Escanea puertos comunes en paralelo para mayor velocidad")
print("• Genera un CSV por cada dominio analizado")
print("• Proporciona resúmenes detallados por dominio")
print("• Manejo de errores robusto")

print("\n🔧 CÓMO USAR EL SCRIPT:")
print("1. Ejecutar: python analizador_subdominios.py")
print("2. Ingresar los dominios uno por uno")
print("3. Escribir 'fin' para comenzar el análisis")
print("4. Los CSV se generarán automáticamente")

print("\n⚠️  NOTA IMPORTANTE:")
print("Este script es para uso legítimo en pruebas de seguridad")
print("Asegúrese de tener autorización para analizar los dominios objetivo")