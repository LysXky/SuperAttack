# Crear documentación técnica del script
documentation = """# ANALIZADOR DE SUBDOMINIOS - DOCUMENTACIÓN TÉCNICA
...
with open('DOCUMENTACION_ANALIZADOR.md', 'w', encoding='utf-8') as f:
    f.write(documentation)

print("✅ Documentación técnica creada: 'DOCUMENTACION_ANALIZADOR.md'")
print("\n📖 La documentación incluye:")
print("• Descripción técnica completa")
print("• Requisitos y dependencias")
print("• Formatos de salida detallados")
print("• Consideraciones de seguridad")
print("• Instrucciones de personalización")
